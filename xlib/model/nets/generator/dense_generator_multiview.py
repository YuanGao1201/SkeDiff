...
import functools
from xlib.model.nets.generator.encoder_decoder_utils import *
  ...
  def forward(self, input):
    ...
    for i in range(self.n_downsampling - 1, -2, -1):
      if i == (self.n_downsampling - 1):
        ...
        view2_next_input = getattr(self.view2Model, 'decoder_layer' + str(i))(view2_next_input)
      if i==2:
        view_next_input_2 = view_next_input
        return view_next_input_2, view1_next_input_3, view2_next_input_3
      if i==3:
        view1_next_input_3 = view1_next_input
        view2_next_input_3 = view2_next_input
    #gy
    # return view_next_input_2, view1_next_input_3, view2_next_input_3
