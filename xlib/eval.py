import argparse
from xlib.config.config import cfg_from_yaml, cfg, merge_dict_and_yaml, print_easy_dict
from xlib.dataset.factory import get_dataset
from xlib.model.factory import get_model
# from xlib.utils.visualizer import tensor_back_to_unnormalization, tensor_back_to_unMinMax
# from xlib.utils.metrics_np import MAE, MSE, Peak_Signal_to_Noise_Rate, Structural_Similarity, Cosine_Similarity, \
...
def parse_args_xlib():
  ...
  parse.add_argument('--dataroot', type=str,
                     # default='/home/fi/lyh/CT1Kdata',
                     default='/home/fi/lyh/CTPelvic1K',
                     dest='dataroot',
  ...
  parse.add_argument('--datasetfile', type=str,
                     # default='./data/test-gy.txt',
                     # default='./data/test-gy1031.txt',
                     # default='./data/test-gy1101.txt',
                     default='/home/fi/GY/medicaldiffusion/xlib/test-gy-hip.txt',
                     dest='datasetfile',
                     help='Train or test or valid file path')
  parse.add_argument('--ymlpath', type=str, default='/home/fi/GY/medicaldiffusion/xlib/experiment/multiview2500/d2_multiview2500.yml', dest='ymlpath',
  ...
  parse.add_argument('--load_path', type=str,
                     # default='/home/fi/GY/X2CT/3DGAN/save_models/multiView_CTGAN/gy-hip/d2_multiview2500/checkpoint',
                     default='/home/fi/GY/X2CT/3DGAN/save_models/multiView_CTGAN/gy/d2_multiview2500/checkpoint',
                     # default='/home/fi/GY/X2CT/3DGAN/save_models/multiView_CTGAN/gy_old-data/d2_multiview2500/checkpoint',
                     dest='load_path',
  ...
  parse.add_argument('--resultdir', type=str, default='./multiview', dest='resultdir',
                     help='dir to save result')
  args = parse.parse_args()
  return args

def evaluate_xlib(args):
  # check gpu
  if args.gpuid == '':
    args.gpu_ids = []
  else:
